...
<link href='http://fonts.googleapis.com/css?family=Open+Sans|Oswald:300,400,700|PT+Sans|Source+Sans+Pro:400,700|Boogaloo' rel='stylesheet' type='text/css' />
...
<style type="text/css">
    ...
    @media screen and (max-width: 801px) {  
	   #az-logo h1 a { background:transparent url( <?php echo esc_url($logo_img_url); ?> ) no-repeat center center; background-size: 240px 45px; }
        #az-headertagline {
            line-height: <?php echo ($customHeaderPadding+100); ?>px;
        }
    }
